...
namespace InterviewBle.Extensions
{
    /// <summary>
    ...
    public static class AdapterExtension
    {
        ...
        public static Task StartScanningForDevicesAsync(this IBleAdapter adapter, CancellationToken cancellationToken)
        {
        ...
        /// <returns>A task that represents the asynchronous read operation. The Task will finish after the scan has ended.</returns>
        public static Task StartScanningForDevicesAsync(this IBleAdapter adapter, Guid[] serviceUuids, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The token to monitor for cancellation requests. The default value is None.</param>
        /// <returns>A task that represents the asynchronous read operation. The Task will finish after the scan has ended.</returns>
        public static Task StartScanningForDevicesAsync(this IBleAdapter adapter, ScanFilterOptions scanFilterOptions, CancellationToken cancellationToken = default)
        {
            return adapter.StartScanningForDevicesAsync(scanFilterOptions, null, cancellationToken: cancellationToken);
        }
        ...
        /// <param name="cancellationToken">The token to monitor for cancellation requests. The default value is None.</param>
        /// <returns>A task that represents the asynchronous read operation. The Task will finish after the scan has ended.</returns>
        public static Task StartScanningForDevicesAsync(this IBleAdapter adapter, Func<IDevice, bool> deviceFilter, CancellationToken cancellationToken = default)
        {
        ...
        /// </summary>
        public static Task<IDevice> DiscoverDeviceAsync(this IBleAdapter adapter, Guid deviceId, CancellationToken cancellationToken = default)
        {
        ...
        /// </summary>
        public static async Task<IDevice> DiscoverDeviceAsync(this IBleAdapter adapter, Func<IDevice, bool> deviceFilter, CancellationToken cancellationToken = default)
        {
        ...
        public static Task ConnectToDeviceAsync(this IBleAdapter adapter, IDevice device, ConnectParameters connectParameters, CancellationToken cancellationToken)
        {
