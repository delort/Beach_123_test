...
using IBleAdapter = InterviewBle.Abstractions.IBleAdapter;
...
namespace InterviewBle.Droid.Services
{
    public class BleImplementation : BleImplementationBase
    {
        ...
        protected override void InitializeNative()
        {
            ...
            var statusChangeReceiver = new BluetoothBroadcastReceiver(state => State = state);
        ...
        protected override IBleAdapter CreateNativeAdapter()
            => new BleAdapter(_bluetoothManager);
    }
}