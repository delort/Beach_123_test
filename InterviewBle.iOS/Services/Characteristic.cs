...
namespace InterviewBle.iOS.Services
{
    public class Characteristic : CharacteristicBase<CBCharacteristic>
    {
        ...
        public Characteristic(CBCharacteristic nativeCharacteristic, CBPeripheral parentDevice, IGattService service, IBleCentralManagerDelegate bleCentralManagerDelegate)
